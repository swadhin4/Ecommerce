            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="alert alert-success">
					<i class="icon-exclamation-sign"></i> You have selected the <strong>ENTERTAINMENT</strong> package.
				 </div>
				 <h2>Choose Your Own Receivers <a href=""><small>Need Help?</small></a></h2>
				 <p>Choose from the HD receivers below. HD receivers are compatible with either HD or standard definition (SD) televisions. If you&rsquo;d like to see SD options, <a href="receivers_entertainment_sd.jsp">click here</a></p>
