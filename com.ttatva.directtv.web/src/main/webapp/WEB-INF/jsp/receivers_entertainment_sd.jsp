         ...
         <div class="page-content">
            ...
            <div class="row">
               <div class="col-md-12">
				 ...
				 <p>Choose from the SD receivers below. SD receivers are compatible with standard definition (SD) televisions only. If you&rsquo;d like to see HD options, <a href="receivers_entertainment_hd.jsp">click here</a></p>
